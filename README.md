...
![Network Overview](https://code.siemens.com/ndriqim.hoxha/parallel-dataset-access-to-multifieldbus-devices/-/tree/main/docs/Network.png?raw=true)

![Concept (Part 1)](https://code.siemens.com/ndriqim.hoxha/parallel-dataset-access-to-multifieldbus-devices/-/tree/main/docs/Concept_1.png?raw=true)

![Concept (Part 2)](https://code.siemens.com/ndriqim.hoxha/parallel-dataset-access-to-multifieldbus-devices/-/tree/main/docs/Concept_2.png?raw=true)

## How to use the solution / application example

This application lays the groundwork of potential future IT applications. It offers a library (found in [mfMb.py](https://code.siemens.com/ndriqim.hoxha/parallel-dataset-access-to-multifieldbus-devices/-/tree/main/src/app/mfMb.py)) with 3 classes (MfMbCtrl, Et200SpMf, IOLinkMaster) which are used for communication with MultiFieldbus devices. In the class MfMbCtrl, the 3-staged Communication Methods for writing DS to / reading DS from MultiFieldbus Devices. This class shall not be changed/modified. 
...
First step to running the code, is to install all the necessary libraries. All the libraries can be found in [requirements.txt](https://code.siemens.com/ndriqim.hoxha/parallel-dataset-access-to-multifieldbus-devices/-/tree/main/src/app/requirements.txt) file. They can be installed directly by running this on the terminal:
```
$ pip install -r requirements.txt
```
Additionally, an application example or an example on how to use these classes can be found in [main.py](https://code.siemens.com/ndriqim.hoxha/parallel-dataset-access-to-multifieldbus-devices/-/tree/main/src/app/main.py) file. Here is an UI programmed with bokeh which runs in a bokeh server. The web-application can run by running this line on the terminal:
```
